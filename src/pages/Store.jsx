...
//   const paging = useSelector((state) => state.store.paging);
//   const is_loading = useSelector((state) => state.store.is_loading);
...
//               dispatch(getPostDB(paging.page));
//             }}
...
//           <button
//             onClick={() => {
//               dispatch(getPostDB(paging.next));
//             }}
//           >
//             다음 게시글 불러오기
//           </button>
